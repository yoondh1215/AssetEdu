        ...
        <form:form action="/fund/update" method="POST" modelAttribute="fund" class="validcheck" >
            <table class="table table-sm table-borderless">
                <tr class="align-middle">
                    ...
                    <td class="w-25"><form:input type="text" class="form-control bg-light" path="fnd01FundCd" data-v-max-length="4" data-v-min-length="4" required="true" readonly="true" /></td>
