...
<main class="container mx-3 my-3">
	<h2><i class="fa-solid fa-cube my-3"></i> 사용자리스트</h2>
	...
	<!-- ctrl shift c 가 주석 단축키임. 다시 하면 주석 해제됨 -->
	<table class="mt-3 table table-hover table-sm dictTable" style="font-size:small">
	  <thead class="table-light">
	    <tr class="text-center">
	      <th scope="col" style="width:50px">No</th>
          <th scope="col" style="width:150px">사용자ID</th>
	      <th scope="col" style="width:250px">사용자이름</th>
          <th scope="col" style="width:150px">사용자전화번호</th>
          <th scope="col" style="width:250px">사용자이메일</th>
	      <th scope="col">비고</th>
	  ...
	  <tbody class="table-group-divider" >
	  	<c:forEach var="list" items="${list}" varStatus="status">
		    <tr class="align-middle">
              ...
              <td class="sys1UserId text-center">${list.sys01UserId}</td>
		      <td class="sys01UserNm">${list.sys01UserNm}</td>
		      <td class="sys01Tel">${list.sys01Tel}</td>
		      <td class="sys01Email">${list.sys01Email}</td>
              ...
              <td align="right">
                  ...
                  <button class="btn btn-danger btn-sm btnDelete" data-dict-id="${list.sys01UserId }" ><span><i class="fa-regular fa-trash-can"></i></span> 삭제</button>
              </td>
		    </tr>
	    </c:forEach>
	  </tbody>
